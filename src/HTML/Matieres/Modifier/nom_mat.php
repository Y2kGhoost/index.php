...
$newNom = $_SESSION['newNom'] ?? null;
$error = $_SESSION['error'] ?? null;

unset($_SESSION['id_mat'], $_SESSION['newNom'], $_SESSION['error']);
?>
...
<head>
    ...
    <title>Modifier Nom Matière</title>
...
<body class="bg-gray-50">
    ...
    <nav class="bg-gray-600 shadow-sm">
        <div class="container mx-auto flex overflow-x-auto">
            <a href="./nom_mat.php" class="text-white px-6 py-4 bg-gray-500 hover:bg-gray-400 transition-colors whitespace-nowrap">
        ...
        <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">
                    <i class="fas fa-signature mr-2"></i>Modifier le Nom de la Matière
                </h2>
                
                <form action="../../../includes/Matieres/Modifier/nom_mat.inc.php" method="post" class="space-y-6">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="newNom" name="newNom" placeholder="Entrez le nouveau nom" required
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-green-700">
                                    Nom modifié avec succès!<br>
                                    ID: <span class="font-bold"><?= htmlspecialchars($id_mat) ?></span> | 
                                    Nouveau Nom: <span class="font-bold"><?= htmlspecialchars($newNom) ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
