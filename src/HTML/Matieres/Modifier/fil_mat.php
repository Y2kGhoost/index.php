...
$newFilName = $_SESSION['newFil'] ?? null;
$error = $_SESSION['error'] ?? null;

unset($_SESSION['id_mat'], $_SESSION['newFilId'], $_SESSION['error']);
?>
...
<head>
    ...
    <title>Modifier Filière Matière</title>
...
<body class="bg-gray-50">
    ...
    <nav class="bg-gray-600 shadow-sm">
        <div class="container mx-auto flex overflow-x-auto">
            ...
            <a href="./fil_mat.php" class="text-white px-6 py-4 bg-gray-500 hover:bg-gray-400 transition-colors whitespace-nowrap">
                <i class="fas fa-graduation-cap mr-2"></i>Filière
            </a>
            <a href="./ens_mat.php" class="text-white px-6 py-4 hover:bg-gray-500 transition-colors whitespace-nowrap">
        ...
        <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">
                    <i class="fas fa-graduation-cap mr-2"></i>Modifier la Filière de la Matière
                </h2>
                
                <form action="../../../includes/Matieres/Modifier/filiere_mat.inc.php" method="post" class="space-y-6">
                    <div>
                    ...
                    <div>
                        <label for="newFil" class="block text-sm font-medium text-gray-700 mb-1">ID Nouvelle Filière</label>
                        <input type="number" id="newFil" name="newFil" placeholder="Entrez l'ID de la nouvelle filière" required
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-green-700">
                                    ...
                                    Nouvelle Filière: <span class="font-bold"><?= htmlspecialchars($newFilName) ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
