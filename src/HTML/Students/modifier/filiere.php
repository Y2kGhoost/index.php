...
<body class="bg-gray-50">
    ...
    <nav class="bg-gray-600 shadow-sm">
        ...
        <a href="./nom-prenom.php" class="text-white px-6 py-4 hover:bg-gray-500 transition-colors whitespace-nowrap">
            ...
            <a href="./filiere.php" class="text-white px-6 py-4 bg-gray-500 hover:bg-gray-400 transition-colors whitespace-nowrap">
        ...
        <div class="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">
                    <i class="fas fa-user-edit mr-2"></i>Modifier la Filière d'un Étudiant
                </h2>

                <form action="../../../includes/Sthandl/Modifier/filiere-modif.inc.php" method="post" class="grid grid-cols-1 gap-6">
                    <div>
                    ...
                    <div>
                        <label for="filiere" class="block text-sm font-medium text-gray-700 mb-1">Nouvelle Filière</label>
                        <div class="relative rounded-md shadow-sm">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <i class="fas fa-graduation-cap text-gray-400"></i>
                            </div>
                            <input type="number" id="id_etudiant" name="id_etudiant" placeholder="Nouveau Filière" required
                                   class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md">
                        </div>
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-green-700">
                                    ...
                                    ID: <span class="font-bold"><?= htmlspecialchars($id_etudiant) ?></span> | Filière: <span class="font-bold"><?= htmlspecialchars($nom_filiere) ?></span>
                                </p>
                            </div>
                        </div>
                    </div>
