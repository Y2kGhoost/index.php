...
<body class="bg-gray-100">
    ...
    <nav class="bg-gray-700 shadow-sm">
        <div class="container mx-auto flex overflow-x-auto">
            ...
            <a href="./suppst.php" class="text-white px-6 py-4 bg-gray-600 hover:bg-gray-500 transition-colors whitespace-nowrap">
    ...
    <main class="container mx-auto py-8 px-4">
        <div class="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-6">
                <i class="fas fa-user-minus mr-2"></i>Supprimer un Étudiant
            </h2>
            
            <form action="../../includes/Sthandl/suprimstd.inc.php" method="post">
                <div class="mb-6">
                    ...
                    <div class="relative rounded-md shadow-sm">
                        ...
                        <input type="number" id="id_etudiant" name="id" placeholder="Entrez l'identifiant" required
